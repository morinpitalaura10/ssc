...
const UpdateUKM = ({ navigation, route }) => {
    ...
    const fetchDetail = useCallback(async () => {
        if (!id_ukm) {
            Alert.alert("Gagal", "id_ukm tidak ditemukan.");
            setLoading(false);
            return;
        }
        ...
        setNamaUkm(data?.nama_ukm || "");
        setKepanjangan(data?.kepanjangan || "");
        setJumlahAnggota(data?.jumlah_anggota?.toString?.() || "");
        setDeskripsiUkm(data?.deskripsi_ukm || "");
        setTempatLatihan(data?.tempat_latihan || "");
        setSince(data?.since?.toString?.() || "");
        setOldLogoUrl(data?.logo_ukm || "");
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const { error } = await supabase.from("tb_ukm").update(payload).eq("id_ukm", id_ukm);
            ...
            Alert.alert("Berhasil", "Data UKM berhasil diperbarui.", [
                    ...
                    <View style={GlobalStyles.formWrap}>
                        ...
                        <View style={GlobalStyles.avatarBox}>
                            {logoLocal ? (
                                ...
                                <Image source={{ uri: oldLogoUrl }} style={GlobalStyles.avatarPreview} />
                            ) : (
